...
public interface UserService {
	 ...
	 *            the password
	 */
	public abstract void createUserWithDefaultAuthority(String username,
			String password);
	 ...
	 */
	public abstract <T> void createUserWithAuthorities(String username,
			String password, T authorities) throws Exception;
	 ...
	 */
	public abstract void changePasswordForPrincipal(String oldPassword,
	 ...
	 *             the oldPassword is incorrect
	 */
	public abstract void changePasswordForUser(String oldPassword,
			String newPassword, String username) throws BadCredentialsException;
